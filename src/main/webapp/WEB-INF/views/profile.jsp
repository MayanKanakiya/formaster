...
<link rel="stylesheet" type="text/css"
	href="assets/custom/plugins/switchery/css/switchery.min.css" />
...
<body
	...
	<div class="wrapper wrapper-top">
		<div class="container-fluid">
			...
			<%
			List<UserDTO> user = (List<UserDTO>) request.getAttribute("userListById");
			if (!user.isEmpty()) {
				for (UserDTO udata : user) {
			%>
			<div class="row mt-2">
		...
		? udata.getImage()
		: "/assets/custom/images/noimage.png"%>" alt="user">
												...
												<h4
													class="block weight-500 text-capitalize txt-dark mb-1 mt-1"><%=udata.getFname()%></h4>
												<h5 class="block mt-1 text-capitalize"><%=udata.getUrole() == 1 ? "Admin" : "User"%></h5>
											</div>
											...
											<div class="pl-2 pr-2">
												<div class="form-group">
													...
													<p class="mb-0"><%=udata.getCno() != null && !udata.getCno().isEmpty() ? udata.getCno() : "Not availble"%></p>
												</div>
												<hr class="mb-2">
											</div>
										</div>
					...
					<div class="card">
						<div class="card-body pl-2 pr-2 pb-0 pt-0">
							<ul class="nav nav-pills navtab-bg pull-in ">
								<li class="nav-item"><a href="#users" data-toggle="tab"
									aria-expanded="true" class="nav-link navlink active"> <i
										class="fa fa-users mr-2"></i>User Details
								</a></li>

								<li class="nav-item"><a href="#settings" data-toggle="tab"
									aria-expanded="false" class="nav-link navlink"> <i
										class="fa fa-cog mr-2"></i> Settings
								</a></li>
							</ul>
									...
									<div class="card-body p-0 pt-2">
										<div class="row pl-2 pr-2">
											<div
												...
												<h5
													class="mt-0 border-bottom font-weight-600 pb-1 mb-2 text-info">Basic
													Details</h5>
											</div>
										</div>
										...
										<div class="row pl-2 pr-2">
											<div
												class="col-xl-4 col-lg-5 col-sm-6 col-xs-12 colmspadding">
											...
											<div
												class="col-xl-2 col-lg-4 col-sm-6 col-xs-12 colmspadding">
												<div class="form-group mb-2">
													<p class="font-weight-600 mb-0">Contact No.:</p>
													<p class="mb-0"><%=udata.getCno() != null && !udata.getCno().isEmpty() ? udata.getCno() : "Not availble"%></p>
												</div>
											...
											<div
												...
												<div class="form-group mb-2">
													...
													<p class="mb-0"><%=udata.getGender()%></p>
												</div>
											</div>

											<div
												class="col-xl-2 col-lg-3 col-sm-6 col-xs-12 colmspadding">
												<div class="form-group mb-2">
													<p class="font-weight-600 mb-0">Valid From:</p>
													<p class="mb-0"><%=udata.getValidfrom() != null && !udata.getValidfrom().isEmpty() ? udata.getValidfrom() : "Not availble"%></p>
												</div>
											</div>
											...
											<div
												...
												<div class="form-group mb-2">
													...
													<p class="mb-0"><%=udata.getValidto() != null && !udata.getValidto().isEmpty() ? udata.getValidto() : "Not availble"%></p>
												</div>
											</div>

											<div
												class="col-xl-4 col-lg-4 col-sm-6 col-xs-12 colmspadding">
												<div class="form-group mb-2">
													<p class="font-weight-600 mb-0">Role:</p>
													<p class="mb-0"><%=udata.getUrole() == 1 ? "Admin" : "User"%></p>
												</div>
											</div>
									...
									<div class="card-body p-0 pt-2">
										<div class="row pl-2 pr-2">
											<div
												class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
												<h5
													class="mt-0 border-bottom font-weight-600 pb-1 mb-2 text-info">Notifications
													Setting</h5>
													...
													<table class="table table-striped mb-0">
														<thead>
															<tr>
																<th>Description</th>
																<th width="10%"><i
																	class="fa fa-bell-o mr-2 font-16" aria-hidden="true"></i>Push</th>
																<th width="10%"><i
																	class="fa fa-envelope-o mr-2 font-16"
														...
														<tbody>
															...
															<tr>
																<td class="pt-2 pb-2"><span class="font-weight-700">Form</span>
																	<p class="mb-0">These are notifications for when
																		admin generates Form or when a Form is completed.</p></td>
															...
															<tr>
																<td class="pt-2 pb-2"><span class="font-weight-700">System
																		Notification</span>
																	<p class="mb-0">These are notifications for when
																		Other system level trasanction generates.</p></td>
																<td class="text-center">
																	<div class="switchery-demo">
																		<input type="checkbox" checked data-plugin="switchery"
																			data-color="#64b0f2" data-size="small" />
